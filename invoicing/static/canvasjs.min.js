/* 
 CanvasJS Chart - v3.14.6 GA - https://canvasjs.com/ 
...
0<d.indexLabelLineThickness&&(g=d.center.x+z*Math.cos(d.midAngle),p=d.center.y+z*Math.sin(d.midAngle),c.strokeStyle=d.indexLabelLineColor,c.lineWidth=d.indexLabelLineThickness,c.setLineDash&&c.setLineDash(H(d.indexLabelLineDashType,d.indexLabelLineThickness)),c.beginPath(),c.moveTo(g,p),c.lineTo(d.indexLabelTextBlock.x,d.indexLabelTextBlock.y),c.lineTo(d.indexLabelTextBlock.x+("left"===d.hemisphere?-m:m),d.indexLabelTextBlock.y),c.stroke()),c.lineJoin="miter");c.save()}function b(a,b){var c=0,c=a.indexLabelTextBlock.y-
...
ca-ea;d=Math.abs((e-f)*(b-a+(d-c))/2);c=X-$;f=e-f;e=c*(e-ca);e=Math.abs(e);e=d+e;for(var d=[],g=0,p=0;p<x.length;p++){if("undefined"===typeof x[p].y)return-1;x[p].y="number"===typeof x[p].y?x[p].y:0;g+=Math.abs(x[p].y)}if(0===g)return-1;for(var l=d[0]=0,k=0,m,r,b=b-a,l=!1,p=0;p<x.length;p++)a=Math.abs(x[p].y)*e/g,l?m=0==Number(c.toFixed(3))?0:a/c:(r=Y*Y*b*b-4*Math.abs(Y)*a,0>r?(r=c,l=(b+r)*(f-k)/2,a-=l,m=f-k,k+=f-k,m+=0==r?0:a/r,k+=a/r,l=!0):(m=(Math.abs(Y)*b-Math.sqrt(r))/2,r=b-2*m/Math.abs(Y),k+=
m,k>f&&(k-=m,r=c,l=(b+r)*(f-k)/2,a-=l,m=f-k,k+=f-k,m+=a/r,k+=a/r,l=!0),b=r)),d.push(m);return d}function b(){if(t&&x){for(var a,b,c,d,e,g,p,k,m,r,n,h,q,s,w,A,y,K,z=[],B=[],P={percent:null,total:null},D=null,E=0;E<x.length;E++)K=N[E],K="undefined"!==typeof K.x5?(K.y2+K.y4)/2:(K.y2+K.y3)/2,K=f(K).x2+1,z[E]=O-(isNaN(K)?0:K)-W;K=0.5*W;for(var E=0,F=x.length-1;E<x.length||0<=F;E++,F--){b=t.reversed?x[F]:x[E];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-E)%t._colorSet.length]:t._colorSet[E%t._colorSet.length];
c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";y=b.indexLabelTextAlign||t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(v?"transparent":null);e=b.indexLabelBorderColor||t.indexLabelBorderColor||(v?"transparent":null);g=l(b.indexLabelBorderThickness)?t.indexLabelBorderThickness:b.indexLabelBorderThickness;p=l(b.indexLabelPadding)?t.options.indexLabelPadding?t.options.indexLabelPadding:t.indexLabelPadding:b.indexLabelPadding;k=b.indexLabelFontColor||
...
0:this.options.labelMaxWidth),p="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>0:1.5*this.labelFontSize;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;a.maxWidth=d;a.maxHeight=p;var u=a.measureText();s=u.height}e=[];q=m=0;if(this.labelAutoFit||this.options.labelAutoFit)if(l(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=
360)),"bottom"===this._position||"top"===this._position)if(d=Math.floor(0.9*h),q=0,!this.chart.panEnabled&&1<=this._labels.length){this.sessionVariables.labelFontSize=this.labelFontSize;this.sessionVariables.labelMaxWidth=d;this.sessionVariables.labelMaxHeight=p;this.sessionVariables.labelAngle=this.labelAngle;this.sessionVariables.labelWrap=this.labelWrap;for(c=0;c<this._labels.length;c++)if(!this._labels[c].breaksLabelType){a=this._labels[c].textBlock;for(var A,f=a.text.split(" "),b=0;b<f.length;b++)n=
...
d?-25:this.sessionVariables.labelAngle):l(this.options.labelMaxWidth)?(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxHeight=p,this.sessionVariables.labelMaxWidth=d,g&&u.width+g.width>>0>2*d&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>d?-25:this.sessionVariables.labelAngle,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=
p,this.sessionVariables.labelWrap=this.labelWrap);else{if(l(this.options.labelWrap))if(!l(this.options.labelMaxWidth))this.options.labelMaxWidth<d?(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=b):(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=p);else if(!l(g))if(b=u.width+g.width>>0,f=this.labelFontSize,q<d)b-2*d>m&&(m=b-2*d,b>=2*d&&b<2.2*d?(this.sessionVariables.labelMaxWidth=
d,l(this.options.labelFontSize)&&12<f&&(f=Math.floor(12/13*f),a.measureText()),this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelAngle=this.labelAngle):b>=2.2*d&&b<2.8*d?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n,this.sessionVariables.labelFontSize=f):b>=2.8*d&&b<3.2*d?(this.sessionVariables.labelMaxWidth=Math.max(d,q),this.sessionVariables.labelWrap=!0,l(this.options.labelFontSize)&&12<this.labelFontSize&&
(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelAngle=this.labelAngle):b>=3.2*d&&b<3.6*d?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=n,this.sessionVariables.labelFontSize=this.labelFontSize):b>3.6*d&&b<5*d?(l(this.options.labelFontSize)&&12<f&&(f=Math.floor(12/13*f),a.measureText()),this.sessionVariables.labelFontSize=
l(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n):b>5*d&&(this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=d,this.sessionVariables.labelFontSize=f,this.sessionVariables.labelMaxHeight=p,this.sessionVariables.labelAngle=this.labelAngle));else if(A===c&&(0===A&&q+this._labels[A+1].textBlock.measureText().width-2*d>m||A===this._labels.length-1&&q+this._labels[A-
1].textBlock.measureText().width-2*d>m||0<A&&A<this._labels.length-1&&q+this._labels[A+1].textBlock.measureText().width-2*d>m&&q+this._labels[A-1].textBlock.measureText().width-2*d>m))m=0===A?q+this._labels[A+1].textBlock.measureText().width-2*d:q+this._labels[A-1].textBlock.measureText().width-2*d,this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=
n;else if(0===m)for(this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?f:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,b=0;b<this._labels.length;b++)a=this._labels[b].textBlock,a.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(d,q),n),u=a.measureText(),b<this._labels.length-1&&(f=b+1,g=this._labels[f].textBlock,g.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(d,q),n),g=g.measureText(),u.width+g.width>>0>2*d&&(this.sessionVariables.labelAngle=
-25))}else(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxHeight=0===this.labelAngle?p:Math.min((b-d*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)),b),n=0!=this.labelAngle?(k-(s+a.fontSize/2)*Math.cos(Math.PI/180*Math.abs(this.labelAngle)))/Math.sin(Math.PI/180*Math.abs(this.labelAngle)):d,this.sessionVariables.labelMaxHeight=this.labelWrap?(k-n*Math.sin(Math.PI/180*Math.abs(this.labelAngle)))/Math.cos(Math.PI/180*Math.abs(this.labelAngle)):
1.5*this.labelFontSize,l(this.options.labelWrap))?l(this.options.labelWrap)&&(this.labelWrap&&!l(this.options.labelMaxWidth)?(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:n,this.sessionVariables.labelMaxHeight=p):(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxWidth=n,this.sessionVariables.labelMaxHeight=Math.max(b,0.9*h),this.sessionVariables.labelWrap=this.labelWrap)):(this.options.labelWrap?
...
a.maxWidth=this.labelMaxWidth=this.sessionVariables.labelMaxWidth,a.fontSize=this.sessionVariables.labelFontSize,a.angle=this.labelAngle=this.sessionVariables.labelAngle,a.wrap=this.labelWrap=this.sessionVariables.labelWrap,a.maxHeight=this.sessionVariables.labelMaxHeight,a.measureText()}else for(c=0;c<this._labels.length;c++)a=this._labels[c].textBlock,a.maxWidth=this.labelMaxWidth=l(this.options.labelMaxWidth)?l(this.sessionVariables.labelMaxWidth)?this.sessionVariables.labelMaxWidth=d:this.sessionVariables.labelMaxWidth:
...
this.sessionVariables.labelWrap=this.labelWrap:this.sessionVariables.labelWrap:this.options.labelWrap,a.maxHeight=l(this.sessionVariables.labelMaxHeight)?this.sessionVariables.labelMaxHeight=p:this.sessionVariables.labelMaxHeight,a.measureText();else if("left"===this._position||"right"===this._position)if(d=l(this.options.labelMaxWidth)?0.3*this.chart.width>>0:this.options.labelMaxWidth,p="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>0:1.5*this.labelFontSize,!this.chart.panEnabled&&
...
g.height>>0,h-2*p>q&&(q=h-2*p,h>=2*p&&h<2.4*p?(l(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelMaxHeight=p,this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize):h>=2.4*p&&h<2.8*p?(this.sessionVariables.labelMaxHeight=b,this.sessionVariables.labelFontSize=this.labelFontSize,this.sessionVariables.labelWrap=!0):h>=2.8*p&&h<3.2*p?(this.sessionVariables.labelMaxHeight=
p,this.sessionVariables.labelWrap=!0,l(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelAngle=l(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle):h>=3.2*p&&h<3.6*p?(this.sessionVariables.labelMaxHeight=b,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelFontSize=
this.labelFontSize):h>3.6*p&&h<10*p?(l(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelMaxWidth=d,this.sessionVariables.labelMaxHeight=p,this.sessionVariables.labelAngle=l(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle):h>10*p&&h<50*p&&(l(this.options.labelFontSize)&&
12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=l(this.options.labelFontSize)?this.labelFontSize:this.options.labelFontSize,this.sessionVariables.labelMaxHeight=p,this.sessionVariables.labelMaxWidth=d,this.sessionVariables.labelAngle=l(this.sessionVariables.labelAngle)?0:this.sessionVariables.labelAngle))):(this.sessionVariables.labelMaxHeight=p,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth?this.options.labelMaxWidth:
...
this.sessionVariables.labelAngle=this.labelAngle:this.sessionVariables.labelAngle:this.labelAngle,a.wrap=this.labelWrap=l(this.options.labelWrap)?l(this.sessionVariables.labelWrap)?this.sessionVariables.labelWrap=this.labelWrap:this.sessionVariables.labelWrap:this.options.labelWrap,a.maxHeight=l(this.sessionVariables.labelMaxHeight)?this.sessionVariables.labelMaxHeight=p:this.sessionVariables.labelMaxHeight,a.measureText();for(c=0;c<this.stripLines.length;c++){var d=this.stripLines[c],y;d.labelFontSize=
"outside"===d.labelPlacement&&l(d.options.labelFontSize)?this.labelFontSize:d.labelFontSize;d.labelFontFamily="outside"===d.labelPlacement&&l(d.options.labelFontFamily)?this.labelFontFamily:d.labelFontFamily;d.labelFontWeight="outside"===d.labelPlacement&&l(d.options.labelFontWeight)?this.labelFontWeight:d.labelFontWeight;d.labelFontStyle="outside"===d.labelPlacement&&l(d.options.labelFontStyle)?this.labelFontStyle:d.labelFontStyle;if("outside"===d.labelPlacement){p=this.sessionVariables.labelMaxWidth;
if("bottom"===this._position||"top"===this._position)l(d.options.labelWrap)&&!l(this.sessionVariables.stripLineLabelMaxHeight)?y=this.sessionVariables.stripLineLabelMaxHeight:this.sessionVariables.stripLineLabelMaxHeight=y=d.labelWrap?0.8*this.chart.height>>0:1.5*d.labelFontSize+("object"===typeof d.labelPadding?(d.labelPadding.top||0)+(d.labelPadding.bottom||0):2*d.labelPadding);if("left"===this._position||"right"===this._position)l(d.options.labelWrap)&&!l(this.sessionVariables.stripLineLabelMaxHeight)?
y=this.sessionVariables.stripLineLabelMaxHeight:this.sessionVariables.stripLineLabelMaxHeight=y=d.labelWrap?0.8*this.chart.width>>0:1.5*d.labelFontSize+("object"===typeof d.labelPadding?(d.labelPadding.top||0)+(d.labelPadding.bottom||0):2*d.labelPadding);l(d.labelBackgroundColor)&&(d.labelBackgroundColor="#EEEEEE")}else p="bottom"===this._position||"top"===this._position?0.9*this.chart.width>>0:0.9*this.chart.height>>0,y=l(d.options.labelWrap)||d.labelWrap?"bottom"===this._position||"top"===this._position?
0.8*this.chart.width>>0:0.8*this.chart.height>>0:1.5*d.labelFontSize+("object"===typeof d.labelPadding?(d.labelPadding.top||0)+(d.labelPadding.bottom||0):2*d.labelPadding),l(d.labelBackgroundColor)&&(l(d.startValue)&&0!==d.startValue?d.labelBackgroundColor=v?"transparent":null:d.labelBackgroundColor="#EEEEEE");a=new ka(this.ctx,{x:0,y:0,backgroundColor:d.labelBackgroundColor,borderColor:d.labelBorderColor,borderThickness:d.labelBorderThickness,cornerRadius:d.labelCornerRadius,maxWidth:d.options.labelMaxWidth?
...
"inside"===this.labelPlacement&&(a-=0<b.length?Math.max.apply(null,b):0,a+=Math.max(p,0<b.length?Math.max.apply(null,b):p)),a<=p&&(a=p),this.stripLineLabelEffectiveWidth=this._stripLineLabels[g].effectiveWidth=p,b.push(p));"inside"===this.labelPlacement&&(a+=e)}return(this.title?this._titleTextBlock.measureText().height+2:0)+a+("inside"===this.tickPlacement?c+this.tickLength:Math.max(c,this.tickLength))+e};y.prototype.createLabelsAndCalculateHeight=function(){var a=0;this._labels=[];this._stripLineLabels=
[];var g=0,c,b=0,e=this.chart.isNavigator?0:"bottom"===this._position&&"inside"===this.labelPlacement||"top"===this._position&&"outside"===this.labelPlacement?2:5;this.labelEffectiveHeight=l(this.labelEffectiveHeight)?0:this.labelEffectiveHeight;var d=[];if("bottom"===this._position||"top"===this._position){this.createLabels();for(b=0;b<this._labels.length;b++){c=this._labels[b].textBlock;c=c.measureText();var p=0,p=0===this.labelAngle?c.height:c.width*Math.sin(Math.PI/180*Math.abs(this.labelAngle))+
c.height*Math.cos(Math.PI/180*Math.abs(this.labelAngle));a<=p&&(this.labelEffectiveHeight=a=p);this._labels[b].effectiveHeight=p}for(b=0;b<this._stripLineLabels.length;b++)"outside"===this._stripLineLabels[b].stripLine.labelPlacement&&(this._stripLineLabels[b].stripLine.value>=this.viewportMinimum&&this._stripLineLabels[b].stripLine.value<=this.viewportMaximum)&&(c=this._stripLineLabels[b].textBlock,c=c.measureText(),p=0===this.labelAngle?c.height:c.width*Math.sin(Math.PI/180*Math.abs(this.labelAngle))+
c.height*Math.cos(Math.PI/180*Math.abs(this.labelAngle)),g=Math.max(g,this._stripLineLabels[b].stripLine.tickLength),"inside"===this.labelPlacement&&(a-=0<d.length?Math.max.apply(null,d):0,a+=Math.max(p,0<d.length?Math.max.apply(null,d):p)),a<=p&&(a=p),this.stripLineLabelEffectiveHeight=this._stripLineLabels[b].effectiveHeight=p,d.push(p));"inside"===this.labelPlacement&&(a+=e)}return(this.title?this._titleTextBlock.measureText().height+2:0)+a+("inside"===this.tickPlacement?g+this.tickLength:Math.max(g,
this.tickLength))+e};y.setLayout=function(a,g,c,b,e,d){var p,h,s,k,n=a[0]?a[0].chart:g[0].chart,m=n.isNavigator?0:10,q=n._axes;if(a&&0<a.length)for(var f=0;f<a.length;f++)a[f]&&a[f].calculateAxisParameters();if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateAxisParameters();if(c&&0<c.length)for(f=0;f<c.length;f++)c[f].calculateAxisParameters();if(b&&0<b.length)for(f=0;f<b.length;f++)b[f].calculateAxisParameters();for(f=0;f<q.length;f++)if(q[f]&&q[f].scaleBreaks&&q[f].scaleBreaks._appliedBreaks.length)for(var v=
q[f].scaleBreaks._appliedBreaks,u=0;u<v.length&&!(v[u].startValue>q[f].viewportMaximum);u++)v[u].endValue<q[f].viewportMinimum||(l(q[f].scaleBreaks.firstBreakIndex)&&(q[f].scaleBreaks.firstBreakIndex=u),v[u].startValue>=q[f].viewPortMinimum&&(q[f].scaleBreaks.lastBreakIndex=u));for(var y=u=0,t=0,x=0,w=0,z=0,B=0,D,F,H=h=0,I,M,L,v=I=M=L=!1,f=0;f<q.length;f++)q[f]&&q[f].title&&(q[f]._titleTextBlock=new ka(q[f].ctx,{text:q[f].title,fontSize:q[f].titleFontSize,fontFamily:q[f].titleFontFamily,fontWeight:q[f].titleFontWeight,
...
q[f].titleMaxWidth||d.height;q[f]._titleTextBlock.maxHeight=q[f].titleWrap?0.8*d.width:Math.min(J,0.8*d.width);switch(q[f]._position){case "left":q[f]._titleTextBlock.angle=-90;break;case "right":q[f]._titleTextBlock.angle=90;break;default:q[f]._titleTextBlock.maxWidth=q[f].titleMaxWidth||d.width,q[f]._titleTextBlock.maxHeight=q[f].titleWrap?0.8*d.height:Math.min(J,0.8*d.height),q[f]._titleTextBlock.angle=0}}if("normal"===e){for(var x=[],w=[],z=[],B=[],O=[],R=[],S=[],E=[];4>u;){var W=0,V=0,U=0,T=
0,$=J=e=0,aa=0,X=0,Y=0,N=p=0;if(c&&0<c.length)for(z=[],f=p=0;f<c.length;f++)z.push(Math.ceil(c[f]?c[f].createLabelsAndCalculateWidth():0)),p+=z[f],$+=c[f]&&!n.isNavigator?c[f].margin:0;else z.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));S.push(z);if(b&&0<b.length)for(B=[],f=N=0;f<b.length;f++)B.push(Math.ceil(b[f]?b[f].createLabelsAndCalculateWidth():0)),N+=B[f],aa+=b[f]?b[f].margin:0;else B.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));E.push(B);p=Math.round(d.x1+p+
$-(c[0]?("inside"===c[0].labelPlacement?c[0].labelEffectiveWidth+(n.isNavigator?0:5):0)+("inside"===c[0].tickPlacement?c[0].tickLength:0):0))+(!c.length||"inside"!==c[c.length-1].labelPlacement||c[c.length-1].title||c[c.length-1].stripLineLabelEffectiveWidth||n.isNavigator?0:5);s=Math.round(Math.min(d.x2-N-aa+(b[0]?("inside"===b[0].labelPlacement?b[0].labelEffectiveWidth+(n.isNavigator?0:5):0)+("inside"===b[0].tickPlacement?b[0].tickLength:0):0),n.width-m));if(a&&0<a.length)for(x=[],f=X=0;f<a.length;f++)a[f]&&
(a[f].lineCoordinates={}),a[f].lineCoordinates.width=Math.abs(s-p),a[f].title&&(a[f]._titleTextBlock.maxWidth=0<a[f].titleMaxWidth&&a[f].titleMaxWidth<a[f].lineCoordinates.width?a[f].titleMaxWidth:a[f].lineCoordinates.width),x.push(Math.ceil(a[f]?a[f].createLabelsAndCalculateHeight():0)),X+=x[f],e+=a[f]&&!n.isNavigator?a[f].margin:0;else x.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():0));O.push(x);if(g&&0<g.length)for(w=[],f=Y=0;f<g.length;f++)g[f]&&(g[f].lineCoordinates={}),g[f].lineCoordinates.width=
Math.abs(s-p),g[f].title&&(g[f]._titleTextBlock.maxWidth=0<g[f].titleMaxWidth&&g[f].titleMaxWidth<g[f].lineCoordinates.width?g[f].titleMaxWidth:g[f].lineCoordinates.width),w.push(Math.ceil(g[f]?g[f].createLabelsAndCalculateHeight():0)),Y+=w[f],J+=g[f]&&!n.isNavigator?g[f].margin:0;else w.push(Math.ceil(g[0]?g[0].createLabelsAndCalculateHeight():0));R.push(w);if(a&&0<a.length){for(f=0;f<a.length;f++){if(a[f]){a[f].lineCoordinates.x1=p;s=Math.round(Math.min(d.x2-N-aa+(b[0]?("inside"===b[0].labelPlacement?
...
1].stripLineLabelEffectiveHeight||n.isNavigator?0:5),$=0<a.length?0:c[f]._labels&&0<c[f]._labels.length?c[f]._labels[0].textBlock.height/2:m,k=Math.round(d.y2-X+(a[0]?("inside"===a[0].labelPlacement?a[0].labelEffectiveHeight+(n.isNavigator?0:2):0)+("inside"===a[0].tickPlacement?a[0].tickLength:0):0)-e-$)-(!a.length||"inside"!==a[a.length-1].labelPlacement||a[a.length-1].title||a[a.length-1].stripLineLabelEffectiveHeight||n.isNavigator?0:5),c[f].lineCoordinates={x1:p-U,y1:h,x2:s-U,y2:k,height:Math.abs(k-
h)},c[f].bounds={x1:p-(z[f]+U),y1:h,x2:s-U,y2:k,height:k-h},c[f].bounds.width=c[f].bounds.x2-c[f].bounds.x1,"inside"===c[f].labelPlacement&&(c[f].lineCoordinates.x1=Math.round(c[0].bounds.x1+z[0]-U-(c[f].labelEffectiveWidth||0)-5),c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),"inside"===c[f].tickPlacement&&(c[f].lineCoordinates.x1-=c[f].tickLength,c[f].lineCoordinates.x2=c[f].lineCoordinates.x1+c[f].lineThickness/2),c[f].title&&(c[f]._titleTextBlock.maxWidth=0<c[f].titleMaxWidth&&
c[f].titleMaxWidth<c[f].lineCoordinates.height?c[f].titleMaxWidth:c[f].lineCoordinates.height),U+=z[f]+c[f].margin);if(b&&0<b.length)for(f=0;f<b.length;f++)b[f]&&(p=s=Math.round((a[0]?a[0].lineCoordinates.x2:g[0].lineCoordinates.x2)-(b[0]?("inside"===b[0].labelPlacement?b[0].labelEffectiveWidth+(n.isNavigator?0:5):0)+("inside"===b[0].tickPlacement?b[0].tickLength:0):0)),$=Math.max(b[f]._labels&&0<b[f]._labels.length?b[f]._labels[b[f]._labels.length-1].textBlock.height/2:0,m),h=Math.round(Math.max(d.y1+
...
0<b.length)for(f=0;f<b.length;f++)b[f].calculateStripLinesThicknessInValues(),b[f].calculateBreaksInPixels();if(a&&0<a.length)for(f=0;f<a.length;f++)a[f].calculateStripLinesThicknessInValues(),a[f].calculateBreaksInPixels();if(g&&0<g.length)for(f=0;f<g.length;f++)g[f].calculateStripLinesThicknessInValues(),g[f].calculateBreaksInPixels()}};y.render=function(a,g,c,b,e){var d=a[0]?a[0].chart:g[0].chart,p=d.ctx,h=[];h.push.apply(h,a);h.push.apply(h,g);h.push.apply(h,c);h.push.apply(h,b);d.alignVerticalAxes&&
d.alignVerticalAxes();p.save();"normal"===e&&(p.beginPath(),a&&a.length&&p.rect(2,a[0].bounds.y1,a[0].chart.width-4,a[a.length-1].bounds.y2),g&&g.length&&p.rect(2,g[g.length-1].bounds.y1,g[0].chart.width-4,g[0].bounds.y2),p.clip());if(a&&0<a.length)for(e=0;e<a.length;e++)a[e].renderLabelsTicksAndTitle();if(g&&0<g.length)for(e=0;e<g.length;e++)g[e].renderLabelsTicksAndTitle();p.restore();if(c&&0<c.length)for(e=0;e<c.length;e++)c[e].renderLabelsTicksAndTitle();if(b&&0<b.length)for(e=0;e<b.length;e++)b[e].renderLabelsTicksAndTitle();
d.preparePlotArea();a=d.plotArea;p.save();p.beginPath();p.rect(a.x1,a.y1,Math.abs(a.x2-a.x1),Math.abs(a.y2-a.y1));p.clip();if(h&&0<h.length){for(e=0;e<h.length;e++)h[e].renderStripLinesOfThicknessType("value");for(e=0;e<h.length;e++)h[e].renderInterlacedColors()}p.restore();p=!1;if(h&&0<h.length){for(e=0;e<h.length;e++)h[e].renderGrid(),v&&(h[e].createMask(),h[e].renderBreaksBackground());for(e=0;e<h.length;e++)h[e].renderAxisLine();for(e=0;e<h.length;e++)h[e].renderStripLinesOfThicknessType("pixel"),
...
"value"===a&&(m.startValue<=this.viewportMinimum&&m.endValue<=this.viewportMinimum||m.startValue>=this.viewportMaximum&&m.endValue>=this.viewportMaximum||l(m.startValue)||l(m.endValue)||isNaN(this.range))||r.push(m))}for(e=0;e<this._stripLineLabels.length;e++)if(m=this.stripLines[e],c=this._stripLineLabels[e],!(c.position<this.viewportMinimum||c.position>this.viewportMaximum||isNaN(this.range)))if(b=this.getPixelCoordinatesOnAxis(c.position),"outside"===c.stripLine.labelPlacement){m&&(this.ctx.strokeStyle=
...
function(){if(this.scaleBreaks&&0<this.scaleBreaks._appliedBreaks.length){var a=this.scaleBreaks._appliedBreaks;v?(this.maskCanvas=wa(this.chart.width,this.chart.height),this.maskCtx=this.maskCanvas.getContext("2d")):(this.maskCanvas=this.chart.plotArea.canvas,this.maskCtx=this.chart.plotArea.ctx);this.maskCtx.save();this.maskCtx.beginPath();this.maskCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.maskCtx.clip();for(var g=0;g<a.length;g++)a[g].endValue<
...
Math.log(a/this.conversionParameters.minimum)/this.conversionParameters.lnLogarithmBase+0.5<<0:"axisX"===this.type?this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5<<0:this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5};y.prototype.getApparentDifference=function(a,g,c,b){var e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];if(this.logarithmic){c=l(c)?g/a:c;for(var d=
...
1===this.options.viewportMaximum&&(this.viewportMinimum/=this.logarithmBase-1/this.logarithmBase),this.options&&"undefined"===typeof this.options.interval&&(this.interval=y.getNiceExponent(Math.ceil(Math.log(h)/g)/(a-1)),c=y.getNiceNumber((this.viewportMaximum-this.viewportMinimum)/(a-1),!0)));if(null===this.minimum||null===this.maximum)"axisX"===this.type?(b=null!==this.minimum?this.minimum:this.dataInfo.min,e=null!==this.maximum?this.maximum:this.dataInfo.max,1===e/b&&(h=Math.pow(this.logarithmBase,
...
e=this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue);this.ctx.strokeStyle=this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;W(this.id);var d,h,l,s,k,n;a=Math.max(this.spacing,3);var m=Math.max(0,this.lineThickness);this.ctx.lineWidth=m;this.ctx.setLineDash&&this.ctx.setLineDash(H(this.lineDashType,m));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===m%2?(b.x<<0)+0.5:b.x<<0,h=1===m%2?(e.x<<0)+0.5:
...
function(a,g,c){var b,e,d,h,r=null,s=null,k=null,n="";this.valueFormatString||("dateTime"===this.parent.valueType?this.valueFormatString=this.parent.valueFormatString:(k=0,k="xySwapped"===this.chart.plotInfo.axisPlacement?50<this.parent.range?0:500<this.chart.width&&25>this.parent.range?2:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0):50<this.parent.range?0:Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?
2:10>this.parent.range?1:0),this.valueFormatString=y.generateValueFormatString(this.parent.range,k)));var m=null===this.opacity?1:this.opacity,q=Math.abs("pixel"===this._thicknessType?this.thickness:this.parent.conversionParameters.pixelPerUnit*this.thickness),f=this.chart.overlaidCanvasCtx,v=f.globalAlpha;f.beginPath();f.strokeStyle=this.color;f.lineWidth=q;f.save();this.labelFontSize=Math.abs(l(this.options.labelFontSize)?this.parent.labelFontSize:this.labelFontSize);this.labelMaxWidth=l(this.options.labelMaxWidth)?
...
this.chart.sessionVariables.mouseY:g});else if("left"===this.parent._position||"right"===this.parent._position)u=this.parent.convertPixelToValue({y:g});for(var t=0;t<this.parent.dataSeries.length;t++)(z=this.parent.dataSeries[t].getDataPointAtX(u,!0,!0))&&0<=z.index&&(z.dataSeries=this.parent.dataSeries[t],null!==z.dataPoint.y&&z.dataSeries.visible&&n.push(z));z=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});var x=z=0;yPercent=cumulativeY=0;for(var u=Infinity,w,t=
...
n[0].dataPoint.x,l(w)&&(w=Math.abs(a-this.parent.convertValueToPixel(100*(n[0].dataSeries.dataPointEOs[n[0].index].cumulativeY/n[0].dataSeries.plotUnit.dataPointYSums[x])))),cumulativeY=n[t].dataSeries.dataPointEOs[n[t].index].cumulativeY,x=n[t].dataPoint.x.getTime?n[t].dataPoint.x.getTime():n[t].dataPoint.x,yPercent=100*(cumulativeY/n[t].dataSeries.plotUnit.dataPointYSums[x]),x=Math.abs(a-this.parent.convertValueToPixel(yPercent)),x<=w&&(w=x,z=t)):(x=Math.abs(a-this.parent.convertValueToPixel(n[t].dataPoint.y)),
x<=u&&(u=x,z=t));l(w)||(u=Math.min(u,w))}w=n[z];t=0;if("bottom"===this.parent._position||"top"===this.parent._position){if("rangeBar"===w.dataSeries.type||"error"===w.dataSeries.type){u=Math.abs(a-this.parent.convertValueToPixel(w.dataPoint.y[0]));for(n=0;n<w.dataPoint.y.length;n++)x=Math.abs(a-this.parent.convertValueToPixel(w.dataPoint.y[n])),x<u&&(u=x,t=n);r=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.y[t])<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.y[t])<<0;this.value=
w.dataPoint.y[t];0!==w.dataPoint.y[t]%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0)));k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.y[t]}):l(this.options.label)?ha(w.dataPoint.y[t],this.valueFormatString,this.chart._cultureInfo):this.label}else"stackedBar"===
w.dataSeries.type?(u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),cumulativeY=w.dataSeries.dataPointEOs[w.index].cumulativeY,r=1===f.lineWidth%2?(this.parent.convertValueToPixel(cumulativeY)<<0)+0.5:this.parent.convertValueToPixel(cumulativeY)<<0,this.value=cumulativeY,0!==cumulativeY%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?
1:0))),k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:cumulativeY}):l(this.options.label)?ha(cumulativeY,this.valueFormatString,this.chart._cultureInfo):this.label):"stackedBar100"===w.dataSeries.type?(u=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),cumulativeY=w.dataSeries.dataPointEOs[w.index].cumulativeY,x=w.dataPoint.x.getTime?w.dataPoint.x.getTime():w.dataPoint.x,yPercent=100*(cumulativeY/w.dataSeries.plotUnit.dataPointYSums[x]),
r=1===f.lineWidth%2?(this.parent.convertValueToPixel(yPercent)<<0)+0.5:this.parent.convertValueToPixel(yPercent)<<0,this.value=yPercent,0!==yPercent%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:yPercent}):l(this.options.label)?
...
axis:this.parent.options,crosshair:this.options,value:w.dataPoint.y}):l(this.options.label)?ha(w.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label);b=e=r;d=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-q/2,y1:d,x2:e+q/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:
k.fontSize/2)+2;k.y+k.height>this.chart.bounds.y2?k.y=this.chart.bounds.y2-k.height:k.y<this.chart.bounds.y1&&(k.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){d=h=s=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:d-q/2,x2:e,y2:h+q/2};t=!1;if(this.parent.labels)for(u=Math.ceil(this.parent.interval),n=0;n<
this.parent.viewportMaximum;n+=u)if(this.parent.labels[n])t=!0;else{t=!1;break}if(t){if("axisX"===this.parent.type)for(u=this.parent.convertPixelToValue({y:g}),z=null,t=0;t<this.parent.dataSeries.length;t++)(z=this.parent.dataSeries[t].getDataPointAtX(u,!0,!0))&&0<=z.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.x}):l(this.options.label)?z.dataPoint.label:this.label)}else"dateTime"!==this.parent.valueType||
this.parent.logarithmic?(0!==w.dataPoint.x%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.x}):l(this.options.label)?ha(w.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label):k.text=
...
this.parent._position?k.x=this.parent.lineCoordinates.x2-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){u=this.parent.convertPixelToValue({x:a});for(t=0;t<this.parent.dataSeries.length;t++)(z=this.parent.dataSeries[t].getDataPointAtX(u,!0,!0))&&0<=z.index&&(z.dataSeries=this.parent.dataSeries[t],null!==z.dataPoint.y&&z.dataSeries.visible&&n.push(z));if(0===n.length)return;n.sort(function(a,
b){return a.distance-b.distance});w=n[0];b=e=r=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.x)<<0;d=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-q/2,y1:d,x2:e+q/2,y2:h};t=!1;if(this.parent.labels)for(u=Math.ceil(this.parent.interval),n=0;n<this.parent.viewportMaximum;n+=u)if(this.parent.labels[n])t=!0;else{t=!1;break}if(t){if("axisX"===this.parent.type)for(u=this.parent.convertPixelToValue({x:a}),z=null,
t=0;t<this.parent.dataSeries.length;t++)(z=this.parent.dataSeries[t].getDataPointAtX(u,!0,!0))&&0<=z.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.x}):l(this.options.label)?z.dataPoint.label:this.label)}else"dateTime"!==this.parent.valueType||this.parent.logarithmic?(0!==w%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/
...
x<=u&&(w=u=x,z=t)):(x=Math.abs(g-this.parent.convertValueToPixel(n[t].dataPoint.y)),x<=u&&(u=x,z=t));l(w)||(u=Math.min(u,w))}w=n[z];t=0;if("rangeColumn"===w.dataSeries.type||"rangeArea"===w.dataSeries.type||"error"===w.dataSeries.type||"rangeSplineArea"===w.dataSeries.type||"candlestick"===w.dataSeries.type||"ohlc"===w.dataSeries.type||"boxAndWhisker"===w.dataSeries.type){u=Math.abs(g-this.parent.convertValueToPixel(w.dataPoint.y[0]));for(n=0;n<w.dataPoint.y.length;n++)x=Math.abs(g-this.parent.convertValueToPixel(w.dataPoint.y[n])),
x<u&&(u=x,t=n);s=1===f.lineWidth%2?(this.parent.convertValueToPixel(w.dataPoint.y[t])<<0)+0.5:this.parent.convertValueToPixel(w.dataPoint.y[t])<<0;0!==w.dataPoint.y[t]%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0)));k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:w.dataPoint.y[t]}):
l(this.options.label)?ha(w.dataPoint.y[t],this.valueFormatString,this.chart._cultureInfo):this.label;this.value=w.dataPoint.y[t]}else"stackedColumn"===w.dataSeries.type?(a=w.dataSeries.dataPointEOs[w.index].cumulativeY,s=1===f.lineWidth%2?(this.parent.convertValueToPixel(a)<<0)+0.5:this.parent.convertValueToPixel(a)<<0,0!==a%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?
2:10>this.parent.range?1:0))),k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:a}):l(this.options.label)?ha(a,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=a):"stackedArea"===w.dataSeries.type?(a=w.dataSeries.dataPointEOs[w.index].cumulativeY,s=1===f.lineWidth%2?(this.parent.convertValueToPixel(a)<<0)+0.5:this.parent.convertValueToPixel(a)<<0,0!==a%1&&l(this.options.valueFormatString)&&(this.valueFormatString=
...
w.dataPoint.x,a=100*(s/w.dataSeries.plotUnit.dataPointYSums[x]),s=1===f.lineWidth%2?(this.parent.convertValueToPixel(a)<<0)+0.5:this.parent.convertValueToPixel(a)<<0,0!==a%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,Math.floor(Math.abs(Math.log(this.parent.range)/Math.LN10))+(5>this.parent.range?2:10>this.parent.range?1:0))),k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:a}):l(this.options.label)?ha(a,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=a):"stackedArea100"===w.dataSeries.type?(s=w.dataSeries.dataPointEOs[w.index].cumulativeY,x=w.dataPoint.x.getTime?w.dataPoint.x.getTime():w.dataPoint.x,a=100*(s/w.dataSeries.plotUnit.dataPointYSums[x]),s=1===f.lineWidth%2?(this.parent.convertValueToPixel(a)<<0)+0.5:this.parent.convertValueToPixel(a)<<0,0!==a%1&&l(this.options.valueFormatString)&&(this.valueFormatString=y.generateValueFormatString(this.parent.range,
...
c.moveTo(a+e/2,g-e/2),c.lineTo(a-e/2,g+e/2),c.stroke())}},drawMarkers:function(a){for(var g=0;g<a.length;g++){var c=a[g];X.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return u}();s.version="v3.14.6 GA";window.CanvasJS&&(s&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=s)})();
