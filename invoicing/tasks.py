...
def match_check_to_invoice(check_id):
    """
    Фоновая задача: Привязка чека к счету по ИНН и сумме.
    """
    try:
    ...
    try:
        ...
        # Если несколько подходящих счетов — не привязываем автоматически,
        # чтобы избежать ошибок (или можно брать самый старый)
        pass